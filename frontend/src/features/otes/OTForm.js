...
export const OTForm = () => {
    ...
    return (_jsx(Card, { title: id ? "Detalle OT" : "Nueva OT", className: "shadow-1 border-round-xl", style: { border: "1px solid #e5e7eb" }, children: _jsx(Formik, { enableReinitialize: true, initialValues: initialValues, validationSchema: ordenTrabajoSchema, onSubmit: async (values, { setSubmitting }) => {
                try {
            ...
            }, children: ({ values, errors, touched, setFieldValue, isSubmitting }) => (_jsxs(Form, { className: "flex flex-column gap-4", children: [_jsxs("div", { className: "grid formgrid", children: [_jsxs("div", { className: "field col-12 md:col-5", children: [_jsx("label", { htmlFor: "vehiculo_id", children: "Vehiculo" }), _jsx(Dropdown, { id: "vehiculo_id", value: values.vehiculo_id, options: vehiculos, onChange: (e) => setFieldValue("vehiculo_id", e.value), placeholder: "Seleccione", className: "w-full" }), touched.vehiculo_id && errors.vehiculo_id && _jsx("small", { className: "p-error", children: errors.vehiculo_id })] }), _jsxs("div", { className: "field col-12 md:col-5", children: [_jsx("label", { htmlFor: "usuario_responsable_id", children: "Responsable" }), _jsx(Dropdown, { id: "usuario_responsable_id", value: values.usuario_responsable_id, options: usuarios, onChange: (e) => setFieldValue("usuario_responsable_id", e.value), placeholder: "Seleccione", className: "w-full" })] }), _jsxs("div", { className: "field col-12", children: [_jsx("label", { htmlFor: "descripcion", children: "Descripcion" }), _jsx(InputText, { id: "descripcion", value: values.descripcion ?? "", onChange: (e) => setFieldValue("descripcion", e.target.value), className: "w-full" })] })] }), _jsx(FieldArray, { name: "detalles", children: ({ push, remove }) => (_jsxs("div", { className: "flex flex-column gap-3", children: [_jsxs("div", { className: "flex justify-content-between align-items-center", children: [_jsx("h3", { children: "Lineas" }), _jsx(Button, { type: "button", icon: "pi pi-plus", label: "Agregar linea", onClick: () => {
                                                const nuevaLinea = {
                                                    tipo_item: "ManoObra",
                                                    descripcion: "",
                                                    cantidad: 1,
